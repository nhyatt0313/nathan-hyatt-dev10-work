 ...
 */
package com.mycompany.matchwork;
...
public class MatchWork {
    public static void main(String[] args) {
        ...
        System.out.println(" The word Cart should come before Horse alphabetically : " + comesBefore("string1", "string2"));
        System.out.println(" Half of 42 = " + halfOf(pi()));
        System.out.println(" (short) Pi = " + pi());
        System.out.println(" The first letter of the word Llama is: " + firstLetter("word"));
        System.out.println(" 1337 x 1337 = " + times1337(75));
