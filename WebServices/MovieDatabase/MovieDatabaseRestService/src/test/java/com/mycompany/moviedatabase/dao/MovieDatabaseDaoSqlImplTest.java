...
public class MovieDatabaseDaoSqlImplTest {
    
    @Autowired
    MovieDatabaseDao dao;
    
    public MovieDatabaseDaoSqlImplTest() {
    }
    ...
    public void testAddGetMovie() {
        ...
        Movie add = dao.addMovie(movie);
        Movie get = dao.getMovie(add.getMovieId());
    ...
    public void testRemoveMovie() {
        ...
        Movie removed = dao.getMovie(movie.getMovieId());
    ...
    public void testSearchMovies() {
        ...
        List<Movie> searched = dao.searchMovies("title");
